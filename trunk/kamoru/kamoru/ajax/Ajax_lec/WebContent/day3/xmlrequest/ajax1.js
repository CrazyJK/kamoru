//클래스의 메소드를 callback function으로 해서 처리하는 방법
...
//서버의 응답 결과는 callback 으로 지정된 콜백함수를 호출한다.
  send : function () {
    ...
    //클래스의 멤버 함수로 callback function 설정 하기 
    this.httpRequest.onreadystatechange = this.onStateChange;
