...
public class MakeASX {
	...
	public static void main(String[] args) throws Exception{
		...
		String str = make.makeASXString("E:\\av", "avi mpg wmv asf mp4 mkv divx");
		PrintWriter writer = new PrintWriter(new FileWriter(new File("C:\\Users\\kAmOrU\\Desktop\\avlist.asx")));
		writer.write(str);
		writer.flush();
		writer.close();
	}
