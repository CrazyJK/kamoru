...
function initMemberInfo(){
	...
	%>
		...
		var icon = new DIcon("/kamoru/images/map/<%= userMap.get("USER_ID") %>.png", new DSize(64, 32));
...
<a href="daum.jsp">refresh</a>
		
<div id="siteDiv" style="POSITION: absolute; OVERFLOW: visible; LEFT:810px; TOP:40px; WIDTH:100px;">		
...
<div id="deptDiv" style="POSITION: absolute; OVERFLOW: visible; LEFT:920px; TOP:40px; WIDTH:300px;z-index:100">		
...
<div id="map" style="POSITION: absolute; OVERFLOW: visible; LEFT:10px; TOP:40px; width:800px;height:600px;border:solid 1px;"></div>
...
<input type="text" name="selectUserID" value=""/>
</form>
<pre style="display:none">
ToDo 1. 행선지 위치 선정시 Ajax활용한 리스트 보여주기.
ToDo 2. javascript 다듬기, 함수명, args, 캡슐화.
</pre>
<iframe name="mapaction" style="width:100%;height:0"></iframe>
</body>
</html>
