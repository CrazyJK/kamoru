...
// BPM
String nh_bpm_date_1 		= getText("nh_bpm_date_dev.txt");
String nh_bpm_ps_1 			= getText("nh_bpm_ps_dev.txt");
String nh_bpm_df_1 			= getText("nh_bpm_df_dev.txt");
String nh_bpm_runhistory_1 	= getText("nh_bpm_runhistory_dev.txt");
String nh_bpm_vmstat_1 		= getText("nh_bpm_vmstat_dev.txt");

// WAS
String nh_was_date_1 	= getText("nh_was_date_dev.txt");
String nh_was_ps_1 		= getText("nh_was_ps_dev.txt");
String nh_was_df_1 		= getText("nh_was_df_dev.txt");
String nh_was_qh_1 		= getText("nh_was_qh_dev.txt");
String nh_was_vmstat_1 	= getText("nh_was_vmstat_dev.txt");
