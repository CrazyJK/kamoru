...
<link rel="stylesheet" href="${resources}/sitemesh/csr.css" />
...
<body id="deco_body">
	...
	<header id="deco_header">
		<h1 id="deco_header_h1">
			<a href="${auth}">Alice&hellip;Auth</a> 
			<span class="deco_header_h1_left_iamge_span">
				<a href="${alice}"><img  alt="Alice logo" src="${resources}/sitemesh/Logo.jpg" height="33px"></a>
			</span>
	...
	<nav id="deco_nav">
		<div id="deco_nav_div">
			<a href="${csr}/list" >CSR</a>
			<a href="${csr}/csd">CSD</a>
			<a href="${csr}/promise" >Promise</a>
			<a href="${alice}" class="deco_nav_div_home">Home</a>
		</div>
	</nav>
