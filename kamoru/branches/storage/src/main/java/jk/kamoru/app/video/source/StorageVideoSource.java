...
import jk.kamoru.app.video.source.storage.VideoStorageFacilities;
...
public class StorageVideoSource implements VideoSource {
	...
	@Autowired private VideoStorageFacilities videoFacilities; 
	@Autowired private VideoStorageFacilities actressFacilities; 
	@Autowired private VideoStorageFacilities studioFacilities; 
